...
kubectl get deploy
# Create services:
kubectl expose deployment deploy-web-regular --dry-run=client -o yaml > canary/service-web-regular.yaml
kubectl expose deployment deploy-web-canary --dry-run=client -o yaml > canary/service-web-canary.yaml
...
kubectl create ingress ingress-web-regular --annotation kubernetes.io/ingress.class=nginx \
        --rule="/=deploy-web-regular:80" --dry-run=client -o yaml > canary/ingress-web-regular.yaml
kubectl create ingress ingress-web-canary \
        ...
        --rule="/=deploy-web-canary:80" --dry-run=client -o yaml > canary/ingress-web-canary.yaml
